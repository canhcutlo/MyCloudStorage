        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StorageItems_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFromSharingHistory = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favorites_StorageItems_StorageItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedWithEmail = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SharedItems_AspNetUsers_SharedByUserId",
                        column: x => x.SharedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedItems_AspNetUsers_SharedWithUserId",
                        column: x => x.SharedWithUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SharedItems_StorageItems_StorageItemId",
                        column: x => x.StorageItemId,
                        principalTable: "StorageItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_StorageItemId",
                table: "Favorites",
                column: "StorageItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_StorageItemId",
                table: "Favorites",
                columns: new[] { "UserId", "StorageItemId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupMembers_Email",
                table: "GroupMembers",
                column: "Email");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMembers_GroupId_Email",
                table: "GroupMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedItems_AccessToken",
                table: "SharedItems",
                column: "AccessToken",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedItems_StorageItemId",
                table: "SharedItems",
                column: "StorageItemId");

            migrationBuilder.CreateIndex(
                name: "IX_StorageItems_Name_ParentFolderId_OwnerId",
                table: "StorageItems",
                columns: new[] { "Name", "ParentFolderId", "OwnerId" },
                unique: true,
                filter: "[IsDeleted] = 0");

            migrationBuilder.CreateIndex(
                name: "IX_StorageItems_OwnerId",
                table: "StorageItems",
                column: "OwnerId");
